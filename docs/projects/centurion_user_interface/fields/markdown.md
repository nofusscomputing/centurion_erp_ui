...
Emoji's are picto-icons that are display within text. to declare use a full-colin `:` on either side of the emoji name. i.e `:smiley:` = :smiley:

Available Emoji's
<!-- ref: https://github.com/markdown-it/markdown-it-emoji/blob/master/lib/data/full.mjs -->
