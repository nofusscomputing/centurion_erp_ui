...
import djangoRootMetadataLoader from "../../djangoRootMetadata";



describe("djangoRootMetadata Page Loader", () => {
    ...
    test("Calls Django Fetcher", async () => {
        ...
        const result = await djangoRootMetadataLoader({ request: request });
